...
(function(T) {
    ...
    $.process = function(tickID) {
        ...
        if (this.tickID !== tickID) {
            ...
            if (!_.bypassed) {
                this._.reverb.roomsize = _._room.process(tickID).cells[0][0];
                this._.reverb.damp = _._damp.process(tickID).cells[0][0];
                this._.reverb.wet = _._mix.process(tickID).cells[0][0];
